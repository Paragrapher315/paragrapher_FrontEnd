...
import Communityd from "./Communityd"
...
class communityExamples extends React.Component{
    ...
    loadData = async () => {
        await axios
          .get(makeURL(references.url_best_community))
          .then((response) => {
