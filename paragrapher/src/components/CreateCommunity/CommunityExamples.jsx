        ...
        <div class="rounded contaner" style={{ backgroundColor: "#d4e1e7" }}>
          ...
          <div className="row">
            <div class="col-12 col-md-6  mt-5">
              <Community
                name={this.state.bestCommunities[0].name}
                bio={this.state.bestCommunities[0].description}
                numberOfmembers={
                  this.state.bestCommunities[0].member_count + " عضو"
                }
                img={this.state.bestCommunities[0].avatar}
                date={
                  ChangeToPersian(
                    this.state.bestCommunities[0].jalali_date.split(" ")[2]
                  ) +
                  " " +
                  this.state.bestCommunities[0].jalali_date.split(" ")[3]
                }
                badge=""
              />
            </div>
            ...
            <div class="col-12 col-md-6">
              <Community
                name={this.state.bestCommunities[1].name}
                bio={this.state.bestCommunities[1].description}
                numberOfmembers={
                  this.state.bestCommunities[1].member_count + " عضو"
                }
                img={this.state.bestCommunities[1].avatar}
                date={
                  ChangeToPersian(
                    this.state.bestCommunities[1].jalali_date.split(" ")[2]
                  ) +
                  " " +
                  this.state.bestCommunities[1].jalali_date.split(" ")[3]
                }
                badge=""
              />
            </div>
