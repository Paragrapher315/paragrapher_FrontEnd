...
import { SearchAuthor } from "../../Utils/Connection";
...
class AuthorSearch extends React.Component{
    ...
    async componentDidMount(){
        ...
        SearchAuthor(this.state.Text, 0, 30).then((ret) => {
    ...
    render(){
        return(
            <div className="container">
                <br/>
                <br/>
                <h5 className="text-center text-primary">"نتایج جستجوی {this.state.Text} در دسته نویسنده ها" </h5>
                <br/>
                <div className="row">
                    ...
                    <AuthorSearchList items={this.state.Result}/>
                    </div>
