...
import { SearchStore } from "../../Utils/Connection";
class StoreSearch extends React.Component{
    ...
    async componentDidMount(){
        ...
        SearchStore(this.state.Text, 0, 30).then((ret) => {
    ...
    render(){
        return(
            <div className="container">
                <br/>
                <br/>
                <h5 className="text-center text-primary">"نتایج جستجوی {this.state.Text} در دسته محصول ها" </h5>
                <br/>
                <div className="row">
                    ...
                    <div className="col-12 col-md-10 col-lg-10 col-xl-10" style={{minHeight:"400px"}}>
                        <StoreSearchList items={this.state.Result}/>
                    </div>
