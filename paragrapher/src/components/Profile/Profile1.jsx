...
import { EditBio, EditPass, EditDob, EditName, JoinCommunity } from "../../Utils/Connection";
        ...
        >
          <div className="col-12 col-lg-3 px-5 px-md-2">
            ...
            >
              ...
              <button
                className="text-start nav-link"
                id="v-pills-joindCommunityList-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-pills-joindCommunityList"
                type="button"
                role="tab"
                aria-controls="v-pills-joindCommunityList"
                aria-selected="false"
              >
                کامیونیتی های عضو شده
              </button>
              <button
                className="text-start nav-link"
          ...
          >
            ...
            <div
              className="tab-pane fade"
              id="v-pills-joindCommunityList"
              role="tabpanel"
              aria-labelledby="v-pills-joindCommunityList-tab"
            >
