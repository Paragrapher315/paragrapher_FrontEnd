            ...
            <div className="row">
                {this.props.items.map(item => (
                    <div className="col-12 col-md-6 col-xl-4">
                        <Community key={item.c_id} name={item.community.name} bio={item.community.description} numberOfmembers={item.community.member_count + " عضو"} img={item.community.avatar} date={ChangeToPersian(item.community.jalali_date.split(" ")[2]) +" "+item.community.jalali_date.split(" ")[3]} badge="مدیر"/>
                    </div>
