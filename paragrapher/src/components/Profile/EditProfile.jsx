...
class ProfileForm extends React.Component {
  ...
  render() {
    ...
    return (
      <Grid
        container
        style={{ marginTop: "20px", borderRadius: "20px", overflow: "hidden" }}
      >
        <Grid
          item
          xs={12}
          sm={4}
          align="center"
          style={{ paddingTop: "20px", backgroundColor: "#e9edde" }}
        >
          <Grid align="center">
            <div
              overlap="circular"
            ...
            <Grid>
              <Box maxWidth="sx">
                ...
                >
                  <DialogTitle align="start" id="form-dialog-title">
                    تغییر رمز عبور
                  </DialogTitle>
          ...
          <Grid align="center">
            ...
            >
              ...
              <Grid itme xs={12}>
                <form noValidate>
                  <TextField
                    style={{ marginTop: "10px", width: "227px" }}
                    id="date"
                    label="تاریخ تولد"
                    type="date"
